...
type ChatServiceClient interface {
	Hi(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *chatServiceClient) Hi(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
type ChatServiceServer interface {
	Hi(context.Context, *Message) (*Message, error)
...
func (UnimplementedChatServiceServer) Hi(context.Context, *Message) (*Message, error) {
...
func _ChatService_Hi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).Hi(ctx, req.(*Message))
	}
